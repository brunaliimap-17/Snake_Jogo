...
let context = canvas.getContext("2d");  // Vai trabalhar num plano 2D 
let box = 32;  //32 pixels de quadradinhos
let snake = [];
snake [0] = {
        x: 8 * box, y: 8 * box
}
...
function criarBG() {
        context.fillStyle="lightgreen";   // Definir cor da tela
        context.fillRect (0, 0, 16 * box, 16* box);  // Desenhar a onde vai acontecer o jogo 
}
...
let jogo = setInterval(iniciarJogo, 100); // esse 100 vai sempre estar atualizando nosso jogo
